 ...
 */
public class DealerNonBlackjack extends DealerMustHit {
    ...
    public Hand applyAction(Action action, int card) {
        switch (action) {
            case HIT:
                ...
                if (newTotal == 17) {
                    if (newSoft && !getRules().dealerStandsOnSoft17) {
    ...
    public boolean equals(Object obj) {
        ...
        final DealerNonBlackjack other = (DealerNonBlackjack) obj;
    ...
    DealerNonBlackjack(Rules rules, int total, boolean soft) {
        super(rules);
        this.total = total;
        this.soft = soft;
    }
